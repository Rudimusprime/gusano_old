      ...
      <main>
        ...
        <section className="about">
          <div>
            ...
            <p> Były to obrazy o różnej tematyce, wśród nich przeważały akty, krajobrazy oraz motywy
              fantastyczne.
              Od
              roku 2006 biorę udział w wystawach cyklicznych
              organizowanych wielu miejscach w Polsce. Czym charakteryzują się moje prace? Obrazy, grafiki i
              rysunki
              łączy jedno - żadne nie posiada tytułu, ponieważ całą interpretację pragnę zostawić
              odbiorcy.</p>
          </div>
        </section>
